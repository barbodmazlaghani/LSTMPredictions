...
add_slope.py gets csv files and from an external excel file, reads slopes and add them to our csv files.
new acceleration files added that consider acceleration as an input feature.