...
def plot_and_save_speed_vs_actual_predicted_dual_y(folder_path, output_folder):
    ...
    for file_name in os.listdir(folder_path):
        if file_name.endswith(".csv"):
            ...
            if all(col in data.columns for col in ['Speed', 'Actual', 'Predicted']):
...
folder_path = "C:/Users/s_alizadehnia/Desktop/LSTMPredictions/Extended/same_data_for_with_without_coolant/predicted_vs_actual_plots/mode_without_coolant_qani"

# Specify the folder path where you want to save the plots
output_folder = "C:/Users/s_alizadehnia/Desktop/LSTMPredictions/Extended/same_data_for_with_without_coolant/predicted_vs_actual_plots/mode_without_coolant_qani"
